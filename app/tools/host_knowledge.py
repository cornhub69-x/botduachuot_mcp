    ...
    try:
        ...
        overview = {
            ...
            "recommended_sequence": [
                ...
                "duachuot_knowledge(section='tools', query='<needed tool>')",
                "duachuot_check_command(command='<command>')",
                "duachuot_run_command(command='<command>', cwd='<project>')",
            ],
        }
